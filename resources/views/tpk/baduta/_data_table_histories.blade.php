    ...
    <div class="card-body">
        ...
        <div class="form-group boxed">
            <div class="input-wrapper">
                ...
                <input type="text" class="form-control" id="text4b" value="{{ $baduta->nama }}" readonly>
            </div>
            <div class="input-wrapper mt-2">
                <label class="label" for="phone4b">NIK</label>
                <input type="tel" class="form-control" id="phone4b" value="{{ $baduta->nik }}">
            </div>
            <div class="input-wrapper mt-2">
                <label class="label" for="phone4b">Tanggal Lahir</label>
                <input type="tel" class="form-control" id="phone4b" value="{{ date('d-m-Y'), strtotime($baduta->tgl_lahir) }}" readonly>
            </div>
            <div class="input-wrapper mt-2">
                <label class="label" for="phone4b">Alamat</label>
                <textarea type="tel" class="form-control" id="phone4b" readonly>{{ $baduta->alamat_catin_pria }}</textarea>
            </div>
        </div>
    </div>
</div>    
<div class="card mt-2">
    <div class="card-body">
        ...
        <div class="form-group boxed">
            <div class="input-wrapper">
                <label class="label" for="text4b">Nama Lengkap</label>
                <input type="text" class="form-control" id="text4b" value="{{ $baduta->nama_catin_wanita }}" readonly>
            </div>
            <div class="input-wrapper mt-2">
                <label class="label" for="phone4b">NIK</label>
                <input type="tel" class="form-control" id="phone4b" value="{{ $baduta->nik_catin_pria }}" readonly>
            </div>
            <div class="input-wrapper mt-2">
                <label class="label" for="phone4b">Tanggal Lahir</label>
                <input type="tel" class="form-control" id="phone4b" value="{{ $baduta->tgl_lahir_catin_pria }}" readonly>
            </div>
            <div class="input-wrapper mt-2">
                <label class="label" for="phone4b">Alamat</label>
                <input type="tel" class="form-control" id="phone4b" value="{{ $baduta->alamat_catin_pria }}" readonly>
            </div>
        </div>
    </div>
</div>  
