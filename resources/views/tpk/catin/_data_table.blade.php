<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $tb->telp_catin_pria }}</td>
            <td class="text-end"><a href="/tpk/catin/histories?kode_catin={{ $tb->kode_catin }}" class="btn btn-sm btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
