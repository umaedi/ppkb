<table class="table">
    ...
    <tbody>
        ...
        <tr>
            <td>{{ $tb->nama }}</td>
            <td>{{ \Carbon\Carbon::parse($tb->tgl_lahir)->isoFormat('D MMMM YYYY') }}</td>
            <td class="text-end"><a href="/tpk/pps/histories?kode_pps={{ $tb->kode_pasca_persalinan }}" class="btn btn-sm btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
