        ...
        <div class="card-body">
            ...
            <div class="form-group boxed">
                <div class="input-wrapper">
                    ...
                    <input type="text" class="form-control" id="text4b" value="{{ $bumil->nama }}" name="nama">
                </div>
                <div class="input-wrapper mt-2">
                    <label class="label" for="phone4b">NIK</label>
                    <input type="number" class="form-control" id="phone4b" value="{{ $bumil->nik }}" name="nik">
                </div>
                <div class="input-wrapper mt-2">
                    <label class="label" for="tgl_lahir">Tanggal Lahir</label>
                    <input type="text" class="form-control" id="tgl_lahir" value="{{ \Carbon\Carbon::parse($bumil->tgl_lahir)->isoFormat('D MMMM YYYY') }}" name="tgl_lahir">
                </div>
                <div class="input-wrapper mt-2">
                    <label class="label" for="phone4b">No Tlp</label>
                    <input type="tel" class="form-control" id="phone4b" value="{{ $bumil->telp }}" name="telp">
                </div>
                <div class="input-wrapper mt-2">
                    <label class="label" for="phone4b">Alamat</label>
                    <textarea class="form-control" name="alamat" id="alamat">{{ $bumil->alamat }}</textarea>
                </div>
                <div class="input-wrapper mt-2">
                    @include('components.btn._loading_submit_bumil')
                    <button id="btn_submit_bumil" type="submit" class="btn btn-primary btn-block">UPDATE DATA BUMIL</button>
                </div>
                <div class="input-wrapper mt-1">
                    <button class="btn btn-danger btn-block" type="button" onclick="hapusBumil('{{ $bumil->kode_bumil }}')">HAPUS DATA BUMIL</button>
                </div>
            </div>
        </div>
    </div> 
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">DATA BUMIL</h5>
